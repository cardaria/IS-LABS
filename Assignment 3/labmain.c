/* labmain.c
 *
 * ORIGINAL ASSIGNMENT 3 SOLUTION
 *
 * This file written 2024 by Artur Podobas and Pedro Antunes
 *
 * This file handles ONLY timer interrupts for a digital clock display.
 * The clock ticks every second and displays time on 7-segment displays.
 *
